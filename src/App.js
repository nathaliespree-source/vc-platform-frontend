  ...
  return (
    <div className="login-container">
      <div className="login-box">
        <img src="/logo-full.png" alt="The Vault" style={{height: 
'200px', 
marginBottom: '10px'}} />
          ...
          {jobsList.map(job => (
            <div key={job._id} className="job-card">
              ...
              <div className="job-meta">
                ...
                {job.expectedStartDate && <span>📅 Start: {job.expectedStartDate}</span>}
              </div>
  ...
  return (
    <div className="dashboard">
      ...
      <div className="job-summary">
        ...
        {job.expectedStartDate && <p>📅 Expected Start: {job.expectedStartDate}</p>}
      </div>
      <form onSubmit={handleSubmit} className="form-large">
...
function AdminAddCompany() {
  const [formData, setFormData] = useState({
    ...
    tempPassword: '', description: '', sector: '', location: ''
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.startMonth && formData.startYear) {
        jobData.expectedStartDate = `${formData.startMonth} ${formData.startYear}`;
      }
  ...
  return (
    <div className="dashboard">
      ...
      <form onSubmit={handleSubmit} className="form-large">
        ...
        <div className="form-row">
          <div className="form-group">
            <label>Expected Start Month</label>
            <select value={formData.startMonth} onChange={(e) => setFormData({...formData, startMonth: e.target.value})}>
...
src="/logo.png" alt="The Vault" style={{height: '140px'}} /></div>
